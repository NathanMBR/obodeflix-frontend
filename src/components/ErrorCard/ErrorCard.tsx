    ...
    const errorMessages = new Map<typeof statusCode, JSX.Element>()
        .set(
            ...
            <>
                ...
                <Typography variant="h4" component="h2">Erro de validação</Typography>
                {
                    reasons && Array.isArray(reasons) && reasons.length > 0
                        ? <>
                            ...
                            {
                                reasons.map(
                                    (reason, index) => <span style={{ display: "block" }} key={index}>{reason}</span>
                                )
                            }
                        </>
                        : null
        ...
        .set(
            ...
            <>
                <ErrorOutline color="warning" sx={errorOutlineStyle} />
                <Typography variant="h4" component="h2">Não encontrado</Typography>
                <Divider />
        ...
        .set(
            ...
            <>
                <ErrorOutline color="error" sx={errorOutlineStyle} />
                <Typography variant="h4" component="h2">Erro interno no servidor</Typography>
                <Divider />
